...
namespace TaskManagement.Migrations
{
    ...
    [Migration("20260110153457_AddArchiveAndAssignment")]
    partial class AddArchiveAndAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppTaskBoardLabel", b =>
                {
            ...
            modelBuilder.Entity("TaskManagement.Models.BoardLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TaskManagement.Models.Project", b =>
                {
                    ...
                    b.Property<DateTime?>("LastAISummaryDate")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TaskManagement.Models.TaskImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("AppTaskBoardLabel", b =>
                {
                    b.HasOne("TaskManagement.Models.BoardLabel", null)
                        .WithMany()
                        .HasForeignKey("LabelsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskManagement.Models.AppTask", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagement.Models.Comment", b =>
                {
                    b.HasOne("TaskManagement.Models.AppTask", "AppTask")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TaskManagement.Models.Project", b =>
                {
                    b.HasOne("TaskManagement.Models.ApplicationUser", "Organizer")
